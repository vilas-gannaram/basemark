...
`dist/basemark` embeds the Bun runtime plus everything the CLI needs — copy it anywhere, no Bun install required. Your markdown input is **not** embedded; it's read from disk each run.
